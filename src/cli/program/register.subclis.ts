...
const entries: SubCliEntry[] = [
  ...
  },
  {
    ...
    hasSubcommands: true,
    register: async (program) => {
      const mod = await import("./register.evolution.js");
      mod.registerEvolutionCommands(program);
    },
  },
  {
    name: "orchestrator",
    ...
    register: async (program) => {
      ...
      mod.registerOrchestratorCommands(program);
    },
  },
  {
    name: "workflow",
    ...
    hasSubcommands: true,
    register: async (program) => {
      const mod = await import("./register.workflow.js");
      mod.registerWorkflowCommands(program);
    },
  },
  {
    name: "update",
